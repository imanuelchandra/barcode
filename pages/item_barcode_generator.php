...
<div class="menuBoxInner printIcon">
  ...
  <div class="sub_section">
	  <div class="btn-group">
      <a target="blindSubmit" href="<?= $_SERVER['PHP_SELF'] . '?' . httpQuery(['action' => 'clear']) ?>" class="notAJAX btn btn-default"> <?php echo __('Clear Print Queue'); ?></a>
      <a target="blindSubmit" href="<?= $_SERVER['PHP_SELF'] . '?' . httpQuery(['action' => 'print']) ?>" class="notAJAX btn btn-default"><?php echo __('Print Barcodes for Selected Data');?></a>
...
if (isset($_GET['keywords']) AND $_GET['keywords']) {
  ...
  $searchable_fields = array('title', 'author', 'class', 'subject', 'itemcode');
  $search_str = '';
